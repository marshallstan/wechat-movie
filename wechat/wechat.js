...
var api = {
	...
	permanent: {
		...
		uploadNewsPic: prefix + 'media/add_uploadimg?',
		...
		that
			...
			.then(function(data) {
				...
				request(options).then(function(response) {
						...
						else throw new Error('Upload material fails!');
					})
					.catch(function(err) {
						reject(err);
					});
			...
			.then(function(data) {
				...
				if (type === 'news' || type === 'video') {
					request(options).then(function(response) {
							var _data = response.body;
							if (_data) resolve(_data);
							else throw new Error('Fetch material fails!');
						})
						.catch(function(err) {
							reject(err);
						});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Delete material fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Count material fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Batch material fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('fetch group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('check group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('update group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('move group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('delete group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request(options).then(function(response) {
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Batch Fetch user fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('List user fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Send to group fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Send By Openid fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Delete Mass fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Preview mass fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Check Mass fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Create Qrcode fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Create long2short fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
		...
		that
			...
			.then(function(data) {
				...
				request({
					...
					var _data = response.body;
					if (_data) resolve(_data);
					else throw new Error('Semantic fails!');
				}).catch(function(err) {
					reject(err);
				});
			});
